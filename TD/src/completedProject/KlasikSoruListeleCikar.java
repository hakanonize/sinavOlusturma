...
public class KlasikSoruListeleCikar extends JFrame {
	private static KlasikSoruListeleCikar sorulistelecikar = new KlasikSoruListeleCikar();
	public static KlasikSoruListeleCikar getInstance() {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KlasikSoruListeleCikar frame = new KlasikSoruListeleCikar();
	 ...
	 * Create the frame.
	 */
	private KlasikSoruListeleCikar() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1239, 694);
		...
		lblNewLabel = new JLabel("F\u0130Z\u0130K KLAS\u0130K");
		lblNewLabel.setFont(new Font("Arial", Font.BOLD, 15));
		lblNewLabel.setBounds(634, 13, 186, 25);
		...
		JLabel lblNewLabel_3 = new JLabel("K\u0130MYA KLAS\u0130K");
		lblNewLabel_3.setFont(new Font("Arial", Font.BOLD, 15));
		lblNewLabel_3.setBounds(1003, 13, 202, 25);
